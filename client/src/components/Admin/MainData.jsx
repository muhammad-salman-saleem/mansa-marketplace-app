...
const MainData = () => {
    ...
    return (
        <div className="px-2">
            ...
            <div className='flex flex-wrap gap-5 pt-6 justify-center items-center '>
                <div className="flex flex-col lg:flex-row sm:flex-col justify-center gap-5 w-full">
                    <div className="bg-white rounded-xl h-auto w-full lg:w-1/2 xl:w-full shadow-lg p-2">
                        <Line data={lineState} className='' />
                    </div>
                    <div className="bg-white rounded-xl shadow-lg p-4 text-center w-full lg:w-[46%] xl:w-1/3">
