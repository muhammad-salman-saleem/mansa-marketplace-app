...
const PrimaryDropDownMenu = ({ setTogglePrimaryDropDown, user, onLinkClick }) => {
    ...
    return (
        <div ref={dropdownRef}  className="absolute w-60 -left-24 ml-2 top-9 bg-white shadow-2xl rounded flex-col text-sm">

            {user.role === "admin" &&
                <Link className="pl-3 py-3.5 border-b flex gap-3 items-center hover:bg-gray-50 rounded-t" to="/admin/dashboard" onClick={() => {
                    onLinkClick();
                }}>
            ...
            <Link className="pl-3 py-3.5 border-b flex gap-3 items-center hover:bg-gray-50 rounded-t" to="/account" onClick={() => {
                onLinkClick();
            }}>
            ...
            {navs.map((item, i) => {
                ...
                return (
                    <React.Fragment key={i}>
                        {title === "Wishlist" ? (
                            <Link className="pl-3 py-3.5 border-b flex gap-3 items-center hover:bg-gray-50" to={redirect} key={i} onClick={() => {
                                onLinkClick();
                            }}>
