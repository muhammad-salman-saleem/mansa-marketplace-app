...
const Products = () => {
    ...
    return (
        <>
            ...
            <MinCategory />
            <main className="w-[100%] mt-14 sm:mt-0 ">
                {/* <!-- row --> */}
                            ...
                            <div className="flex flex-col gap-2 py-3 text-sm overflow-hidden">
                                ...
                                <div className="flex flex-col gap-2 border-b px-4">
                                    ...
                                    <Slider
                                        ...
                                        max={200000}
                                    />
                                    <div className="flex md:flex-wrap lg:flex-nowrap gap-3 items-center justify-center mb-2 min-w-full">
                    ...
                    <div className="flex-1">
                        ...
                        {loading ? <Loader /> : (
                            <div className=" flex flex-col gap-2 pb-4 justify-center items-center w-full overflow-hidden bg-white">
                                <div className="grid grid-cols-1 2xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 w-full place-content-start overflow-hidden pb-4 border-b">
